...
const Footer = () => {
  return (
    <div className="rounded-div mt-8 pt-8 text-primary mb-6">
      <div className="grid md:grid-cols-2">
        ...
        <div className="text-right">
          <div className="w-full flex justify-end">
            <div className="w-full md:w-[300px] py-4 px-8 relative">
              <div className="flex justify-center md:justify-end py-8 md:py-0 md:pb-4 mt-[-1rem]">
                <ThemeToggle/>
              </div>
              ...
              <div className="py-4">
                <form action="">
                  <input
                    className="bg-secondary border border-input p-2 w-full shadow-xl rounded-2xl md:w-auto"
                    type="email"
